...
function PDFEditor() {
  ...
  const handleRotate = async () => {
    ...
    const res = await axios.post("http://localhost:5000/api/rotate", form, { responseType: "blob" });
  ...
  const handleMerge = async () => {
    ...
    const res = await axios.post("http://localhost:5000/api/merge", form, { responseType: "blob" });
  ...
  const handleSplit = async () => {
    ...
    form.append("end", end);
    const res = await axios.post("http://localhost:5000/api/split", form, { responseType: "blob" });
  ...
  const handleWatermark = async () => {
    ...
    const res = await axios.post("https://pdf-backend.onrender.com/api/pdf-editor", form, { responseType: "blob" });
